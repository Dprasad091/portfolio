  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-col gap-5 justify-center m-auto text-center md:text-start">
        ...
        >
          I&apos;m a full-stack developer and AI enthusiast, skilled in front-end and back-end technologies and proficient with AI tools and frameworks. I thrive on building innovative, impactful projects that solve complex problems with creativity and precision. Driven by a forward-thinking mindset, I craft intelligent solutions that push technological boundaries and shape the future of digital experiences.
        </motion.p>
